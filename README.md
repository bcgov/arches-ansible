...
1. Create the image:
   ...
   `docker build . --tag bcgov:arches-deployer`

2. Run the container:

   `docker run -dit -v ~/.m2/repository:/apps_ux/repo --name arches-deployer bcgov:arches-deployer`

2. Enter the container:
   
   `docker exec -it arches-deployer /bin/bash`
